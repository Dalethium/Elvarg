...
public final class FileArchive {
	...
	/**
	 * The identifiers (i.e. hashed names) of each of the entries in this
	 * Archive.
	 */
	...
	/**
	 * Whether or not this Archive was compressed as a whole: if false,
	 * decompression will be performed on each of the individual entries.
	 */
