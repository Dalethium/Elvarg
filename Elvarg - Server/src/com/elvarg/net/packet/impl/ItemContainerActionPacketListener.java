...
public class ItemContainerActionPacketListener implements PacketListener {
	...
	private void firstAction(Player player, Packet packet) {
	...
	private void secondAction(Player player, Packet packet) {
		int interfaceId = packet.readInt();
	...
	private void thirdAction(Player player, Packet packet) {
		int interfaceId = packet.readInt();
		int id = packet.readShortA();
		int slot = packet.readShortA();
		// Bank withdrawal..
	...
	private void fourthAction(Player player, Packet packet) {
		int slot = packet.readShortA();
		int interfaceId = packet.readInt();
		int id = packet.readShortA();
		// Bank withdrawal..
	...
	private void fifthAction(Player player, Packet packet) {
		int interfaceId = packet.readInt();
		int slot = packet.readLEShort();
	...
	private void sixthAction(Player player, Packet packet) {
	}
}
